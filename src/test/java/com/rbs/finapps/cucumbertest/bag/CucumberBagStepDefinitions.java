...
public class CucumberBagStepDefinitions extends SpringBootBaseIntegrationTest {
 
    private final Logger log = LoggerFactory.getLogger(CucumberBagStepDefinitions.class);
